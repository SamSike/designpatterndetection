...
def extract_features(inDir, outDir, parser):
    ...
    # Dictionary to hold the names of files and their projects
    proj_file_list = defaultdict(list)
    # List to hold the features extracted from each file
    method_summaries = []
        ...
        for root, drs, files in os.walk(
            ...
            for input_file in files:
                ...
                try:
                    ...
                    # Changed from python 3 to python 2 syntax for consistency
            ...
            for type_decl in tree.type_declarations:
                ...
                for method_decl in methods:
                    try:
                        ...
                        # added str(e) to remove TypeError
                        logger.error(str(e))
                        logger.error(
                            "\t- Error occured in add_class_labels function")
                        continue
        # else:
